import { createClient, OpenapiDocument } from "./api-helpers.js";
...
export const search =  createClient<Search>(searchOpenapi,"https://search.actionschema.com/openapi.json",{access_token: process.env.undefined})
